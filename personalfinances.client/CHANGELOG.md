...
- Create Angular project with ng: `ng new personalfinances.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`personalfinances.client.esproj`).
